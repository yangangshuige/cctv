...
import com.base.library.net.CustomInterceptor;
import com.base.library.net.RetrofitConfig;
...
public class OldApiManager {
    ...
    private static OldApiManager apiManager;
    public static OldApiManager getInstence() {
        if (apiManager == null) {
            apiManager = new OldApiManager();
        }
        return apiManager;
    }

    public OldApiManager() {
