...
public class ShareCarFragment extends BaseFragment {
    ...
    public static ShareCarFragment newInstance(String param1, String param2) {
        ShareCarFragment fragment = new ShareCarFragment();
    ...
    public int getContentLayout() {
        return R.layout.fragment_share_car;
    }
